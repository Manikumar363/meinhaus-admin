      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <div className="ml-auto flex items-center gap-4">
            ...
            <div className="flex items-center cursor-pointer gap-2" onClick={() => setIsViewLogsOpen(true)}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-semibold text-gray-900">#HAL2GK765</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-semibold text-gray-900">jamesrobert@gmail.com</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-semibold text-gray-900">+11209876543</div>
                    </div>
                  </div>
              ...
              <tbody>
                {servicesData.map((service, idx) => (
                  <tr key={service.id} className="border-b text-sm">
                    ...
                    <td className="px-3 py-4 font-medium">{service.serviceName}</td>
                    <td className="px-3 py-4">{service.regAmount}</td>
                    <td className="px-3 py-4 font-semibold">{service.totalCost}</td>
                    <td className="px-3 py-4">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${service.paymentStatusColor}`}>
                        {service.paymentStatus}
                      </span>
                    </td>
                    <td className="px-3 py-4">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${service.jobAssignStatusColor}`}>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            ...
            <div className="p-6">
              <p className="text-gray-600 text-sm mb-6 leading-relaxed">
                (The Timestamps here show everytime the user viewed the relevant information. The System records only those attempts that occur at least 30 minutes apart)
              </p>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-100">
                      ...
                      <th className="text-left py-4 px-6 font-semibold text-gray-700">Viewing Time</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-t border-gray-200">
                      <td className="py-4 px-6 text-gray-900">1</td>
                      <td className="py-4 px-6 text-gray-900">28 August, 2025 at 11:45:05</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4">
            ...
            <div className="p-6 text-center">
              <p className="text-gray-500 text-sm leading-relaxed mb-8">
                The customer hasn't paid registration amount yet and the service is still just requested. Do you still want to assign a professional?
              </p>
            ...
            <div className="flex items-center justify-between p-6 border-b relative">
              <div className="w-full">
                ...
                <p className="text-gray-500 text-sm">
                  (The service will be added to overall project, giving you the freedom to assign new professional to it.)
                </p>
              </div>
              <button 
      ...
      {isEditServiceOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl max-w-xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between p-6 border-b relative">
              <div className="w-full">
                <h2 className="text-xl font-semibold mb-4">Edit Service Details</h2>
          ...
          <div className="bg-white rounded-lg shadow-lg max-w-md w-full mx-2">
            ...
            <div className="p-2 text-center">
              <p className="text-gray-500 text-sm leading-relaxed mb-4">
                Deleting this service will permanently remove its data. Are you sure you want to proceed?
              </p>
